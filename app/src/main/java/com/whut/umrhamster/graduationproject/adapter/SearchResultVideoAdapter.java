...
public class SearchResultVideoAdapter extends RecyclerView.Adapter<SearchResultVideoAdapter.ItemViewHolder> {
    private List<Video> videoList;
    private Context context;

    private OnItemClickListener onItemClickListener;

    public SearchResultVideoAdapter(List<Video> videoList,Context context){
